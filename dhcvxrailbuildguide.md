...
![VMWAREAccount1](images/DHC-Build-Guide/vmwareaccount1.jpg) <br>
-Make sure to select VMware partner YES and Organization.<br>
![VMWAREAccount2](images/DHC-Build-Guide/vmwareaccount2.jpg) <br>
...
![VMWAREAccount3](images/DHC-Build-Guide/vmwareaccount3.jpg) <br>
...
2. Provide First Name, Last name and email address- xxx@atos.net that will be used for registration<br>
...
6.	At this site- account will be created and you will be redirected to finish the regiration-
...
10. Confirm organization selection and click on submit-
...
Note: There are **tags** defined in __dhc-vxrailbuilder.yml__. You may find it useful.
...
Review dhc-vxrailbuilder.yml playbook to understand DHC build order and read tags names reffering to the tasks
